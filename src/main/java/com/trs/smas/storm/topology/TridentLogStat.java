...
public class TridentLogStat {
	...
	public static StormTopology buildTopology(LocalDRPC drpc) {
		FixedBatchSpout spout = new FixedBatchSpout(new Fields("log"), 3,
				new Values("[2013.04.01 19:23:47] [stat] [320]"), new Values(
						"[2013.04.01 19:23:47] [query] [320]"),
				new Values("[2013.04.02 19:23:47] [stat] [50]"), new Values(
						"[2013.04.03 19:23:47] [stat] [50]"), new Values(
						"[2013.04.04 19:23:47] [count] [50]"));
		spout.setCycle(true);
